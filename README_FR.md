# Détails sur l'outil Diablo Runewords Catalog

Cette page détaille mes motivations, mes frustrations, et l'histoire derrière l'idée et la construction de mon outil.
...
Je ne puis le dire avec certitude, mais j'ai quelques idées floues à trier.
